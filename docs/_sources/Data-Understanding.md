...
## Eksplorasi Data
Dataset Iris berisi 150 data bunga iris yang terbagi ke dalam 3 spesies:
- Iris Setosa
- Iris Versicolor
- Iris Virginica

Setiap data memiliki 4 atribut numerik:
- Sepal Length (cm) (Numeric) Menunjukkan panjang kelopak luar bunga iris dalam satuan sentimeter.
- Sepal Width (cm) (Numeric) Menunjukkan lebar kelopak luar bunga iris dalam satuan sentimeter.
- Petal Length (cm) (Numeric) Menunjukkan panjang mahkota bunga iris dalam satuan sentimeter.
- Petal Width (cm) (Numeric) Menunjukkan lebar mahkota bunga iris dalam satuan sentimeter.
...
# Deskriptif Data
Jumlah masing-masing Data (n) : 50
### Iris Setosa
...
##### Distribusi Data Fitur Numerik pada Data Iris
...
##### Analisa Korelasi Sepal Lenght & Sepal Widht
...
##### Analisa Korelasi Petal Lenght & Petal Widht
...
# TUGAS TAMBAHAN
# DATA UNDERSTANDING
##### Pengukuran Jarak pada Dataset Iris
Dalam proses data mining, tahap Data Understanding bertujuan untuk memahami karakteristik data sebelum dilakukan pemodelan. Salah satu teknik eksplorasi yang digunakan adalah pengukuran jarak (distance measurement) untuk mengetahui tingkat kemiripan antar data.

Dataset yang digunakan dalam tugas ini adalah Iris Dataset.
#### deskripasi Dataset
Dataset Iris memiliki 150 data dengan 5 atribut:
| No | Atribut      | Tipe Data | Keterangan         |
| -- | ------------ | --------- | ------------------ |
| 1  | sepal_length | Numerik   | Panjang sepal (cm) |
| 2  | sepal_width  | Numerik   | Lebar sepal (cm)   |
| 3  | petal_length | Numerik   | Panjang petal (cm) |
| 4  | petal_width  | Numerik   | Lebar petal (cm)   |
| 5  | species      | Kategori  | Jenis bunga        |

Dataset terdiri dari 3 spesies:
- Iris Setosa
- Iris Veersicolor
- Iris Virginca
...
Rumus : ![image](https://hackmd.io/_uploads/r1wF__VY-x.png)
- x dan 𝑦 adalah dua data
- 𝑖 adalah atribut numerik

#### Hasil Pengukuran jarak
![image](https://hackmd.io/_uploads/By3kcuEt-l.png)
